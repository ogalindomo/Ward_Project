...
#X vectors of the type [Addition of word scores,length of sentence]
#Y 0-1 sentence matters if 1
...
#X vectors that represent the addition of embeddings per sentence
#Y 0-1 sentence matters if 1
